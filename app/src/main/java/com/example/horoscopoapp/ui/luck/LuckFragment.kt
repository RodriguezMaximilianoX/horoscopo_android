...
import com.example.horoscopoapp.ui.providers.RandomCardsProvider
...
class LuckFragment : Fragment() {
    ...
    private fun preparePrediction() {
        val currentLuck = randomCardsProvider.getLucky()
    ...
    private fun growCard() {
        val growAnimation = AnimationUtils.loadAnimation(
            requireContext(),
            R.anim.grow
        )
